...
또한, 각 에러에 담긴 정보는 다음 구조를 따른다.

include::{snippets}/errors/response-fields-beneath-_embedded.errorDtoList.adoc[]
...
operation::create-event[snippets='request-fields,curl-request,http-request,request-headers,http-response,response-headers,links']
operation::create-event[snippets='curl-request']
...
operation::update-an-event[snippets='request-fields,curl-request,http-response,links']